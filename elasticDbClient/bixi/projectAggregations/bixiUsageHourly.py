##############################################################
# Usage of bixies hourly
##############################################################

def bixiUsageHourly(stationName, startTimeStamp, endTimeStamp):	
	...
	print "\n\nQuerying for usage of bixies every hour at stationName: {}, starting from: {} to: {}\n".format(stationName, startTimeStamp, endTimeStamp)
	...
	# Getting results
	results = es.search(index="bixiusage", doc_type = "hourly", body=query, size="10000", filter_path = ['hits.hits._source.station_name' , 'hits.hits._source.time_stamp', 'hits.hits._source.delta'])
	print "\nRaw results are:\n{}".format(results)
...
if __name__ == "__main__":
	...
	results = bixiUsageHourly(stationName, startTimeStamp, endTimeStamp)
