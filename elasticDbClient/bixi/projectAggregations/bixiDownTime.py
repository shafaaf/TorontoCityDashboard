...
def bixiDownTime(stationName, startTimeStamp, endTimeStamp):	
	...
	print "\n\nQuerying for downtime of bikes at stationName: {}, starting from: {} to: {}\n".format(stationName, startTimeStamp, endTimeStamp)
	...
	# Getting results
	results = es.search(index="bixidowntime", doc_type = "intervals", body=query, size="10000", filter_path = ['hits.hits._source.time_stamp' , 'hits.hits._source.station_name', 'hits.hits._source.bixi_status'])
	print "\nRaw results are:\n{}".format(results)
...
if __name__ == "__main__":
	...
	results = bixiDownTime(stationName, startTimeStamp, endTimeStamp)
